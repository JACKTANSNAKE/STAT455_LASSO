...
&\propto\exp\left(-\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta) \right) \exp\left(-\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\right)\\
&=\exp\left(-\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)-\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\right)
\end{aligned}$$
...
$$\begin{aligned}\\
&\arg\max\text{ }\exp\left(-\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)-\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\right)\\
=\text{ }&\arg\max\text{ }-\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)-\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\\
=\text{ }&\arg\min\text{ }\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)+\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\\
=\text{ }&\arg\min\text{ -log posterior}\\
\end{aligned}$$

$$\begin{aligned}
\arg\min\text{ -log posterior}
&=\arg\min-\log(\exp\left(-\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)-\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\right))\\
&=\arg\min-\left(-\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)-\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\right)\\
&=\arg\min\frac{1}{2}(\mathbf{y} - \mathbf{X}\boldsymbol\beta)^\top (\mathbf{y} - \mathbf{X}\boldsymbol\beta)+\frac{\lambda^2}{2}\sum_{j=1}^p\beta_j^2\\
